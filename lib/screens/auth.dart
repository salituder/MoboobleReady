  ...
  Widget build(BuildContext context) {
    ...
    Widget _logo(){
      return Padding(
        ...
        child: Container(
          child: Align(
            child: Text('Mobooble', style: TextStyle(fontSize: 45,fontWeight: FontWeight.bold, color: Colors.white),)
          )
        ),
      );
    }
      ...
      if(user == null)
        {
          Fluttertoast.showToast(
            msg: "Не получается войти. Пожалуйста, проверьте логин или пароль!",
